...
- [x] 03-01-PLAN.md — Backend CRUD API + Supabase schema + project list page
- [x] 03-02-PLAN.md — GitHub clone integration + project detail page + create modal
- [x] 03-03-PLAN.md — AI analysis service + delete + error handling polish
...
- [x] 04-01-PLAN.md — Backend services (AI generation + Hadolint validation) + API + frontend editor components
...
- [ ] 05-01-PLAN.md — Backend services: CICDGenerator + ActionlintValidator + API routes
- [ ] 05-02-PLAN.md — Frontend CI/CD Pipeline tab with YAML editors and download
- [ ] 05-03-PLAN.md — Customization form, secrets display, overview stage indicator
...
| 4. Dockerfile Generation | 1/1 | In Progress|  |
| 5. CI/CD Pipeline Generation | 0/3 | Not started | - |
